        ...
        <section id='a-box'>
            <div class="profile-img" :style="{opacity:1-state.scrollHeight*0.05}">
                <img class="profile-logo"
                     src="https://s2.loli.net/2024/03/04/WU7dTn3zjbeyKxP.jpg"
                     alt="logo">
            </div>
            <h2 class='a-second-title'>Hello! I'm ZHOU YI</h2>
            <p class='a-second-title-sub'>123456</p>
            <canvas></canvas>
        </section>
...
<style lang="scss" scoped>
    .pointers-container {
        ...
        #a-box {
            ...
            .a-second-title {
                -webkit-box-reflect: below -30px linear-gradient(transparent, rgba(0, 0, 0, .4));
            }
